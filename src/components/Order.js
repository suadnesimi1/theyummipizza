      ...
      <div className="card">
        ...
        <div className="card-content">
          ...
          <form onSubmit={ this.postOrder }>
            <div className="field">
              <label className="label heading">Selected Pizza</label>
            ...
            <div className="field">
              <label className="label heading">Extra</label>
              <div className="control has-icons-left">
                <input className="input" type="text" placeholder="" name="extra" value={ this.props.toppings } disabled/>
                <span className="icon is-small is-left">
                  <i className="fas fa-user"></i>
                </span>
              </div>
            ...
            <div className="field">
              <label className="label heading">Payment</label>
              <div className="control has-icons-left">
                <input className="input" type="text" placeholder="" name="location" value={ this.props.location } disabled/>
                <span className="icon is-small is-left">
                  <i className="fas fa-user"></i>
